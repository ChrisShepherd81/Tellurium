...
#define DCFRejectPulseWidth 10  // Minimal pulse width
#define DCFSplitTime 140        // Specifications distinguishes pulse width 100 ms and 200 ms. In practice we see 130 ms and 230
